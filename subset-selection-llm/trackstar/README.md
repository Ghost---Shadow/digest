...
Together, these formulations measure the similarity between training and evaluation examples in terms of how their gradients align after accounting for magnitude, curvature, and noise—all key steps for tracing and scaling influence in large models.
